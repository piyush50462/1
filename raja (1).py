...
TOKEN = "8026353575:AAED98zjKTN3WnJZo9W1ua9xrEejn5QIY_o"  # 🔥 Replace with your bot token
API_URL = f"https://api.telegram.org/bot{TOKEN}"

ADMIN_IDS = [7855020275]  # 🔥 Replace with your Admin IDs
...
def handle_attack(chat_id, command):
    if chat_id not in users:
        send_message(chat_id, "🚫 **आपको अनुमति नहीं है @rajaraj_04!**")
        return
...
def handle_price(chat_id):
    ...
    price_message = (
        ...
        "• 6 Day:   410💵\n"
        "• 7 Day:   450💵\n\n"
        "🔐 For private inquiries, reach out to the owners: @rajaraj_04"
    )
...
def handle_start(chat_id):
    send_message(chat_id, "WELCOME TO RAJA BHAI! 🔥✨\nUse `/help` to see available commands.")
